...
class CubegalleryViewCubegallery extends JViewLegacy
{
	...
	function display($tpl = null)
	{
		...
		// or $params = JComponentHelper::getParams('com_cubegallery'); 
		...
		if ((!$active) || ((strpos($active->link, 'view=cubegallery') === false) || (strpos($active->link, '&id=' . (string) $this->item->id) === false))) {
			if ($layout = $params->get('cubegallery_layout')) {
