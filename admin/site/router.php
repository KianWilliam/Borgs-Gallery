...
function CubegalleryBuildRoute(&$query)
{
		$segments = array();
		
			$app		= JFactory::getApplication();
	        $menu		= $app->getMenu();
	        $params		= JComponentHelper::getParams('com_cubegallery');
	...
	if (isset($query['view']) && ($mView == $query['view']) and (isset($query['title'])) and ($mId == intval($query['title']))) {
		...
		if (isset($view) and  $view == 'cubegallery' ) {
...
function CubegalleryParseRoute($segments)
{
		$vars = array();
