...
require_once JPATH_BASE . '/components/com_cubegallery/models/cubegallery.php';

class ModCubegalleryHelper
{
	public static function getGallery($pk)
	{
          $activemodel = JModelLegacy::getInstance('Cubegallery', 'CubegalleryModel');
		 // $activemodel->setState('cubegallery.title', $pk);
